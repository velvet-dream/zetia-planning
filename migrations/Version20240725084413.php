 ...
 */
final class Version20240725084413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_user_usr (usr_id INT AUTO_INCREMENT NOT NULL, usr_name VARCHAR(127) NOT NULL, usr_first_name VARCHAR(127) NOT NULL, usr_mail VARCHAR(127) NOT NULL, usr_password VARCHAR(127) NOT NULL, usr_role VARCHAR(255) NOT NULL, usr_avatar VARCHAR(255) DEFAULT NULL, PRIMARY KEY(usr_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
